...
<table class="bare-table">
  ...
  <tr class="bare-row">
    ...
    <td>Start with the <a href="{{ site.baseurl }}/onboarding/">New to 18F</a> section and complete the listed tasks</td>
    <td class="bare-cell"><input type="checkbox" /></td>
  </tr>
  <tr class="bare-row">
    <td></td>
