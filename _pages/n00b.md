...
## Help us making onboarding better

Below are a huge number of links to help you get set up. As you go, it is super helpful if you can keep track of what was missing or confusing, and let us know in one of the following ways:

* The #wg-onboarding channel on Slack
* Once you have GitHub access:
    * [Opening a GitHub issue](https://github.com/18F/hub-pages-private/issues/new)
    * [Fixing the page directly](https://github.com/18F/hub-pages-private/edit/master/n00b.md)
...
* [Set up Slack.](../private/slack-tips/) You'll have questions about the steps below, and you'll need to ask for help.  _(Hint: There's as [#questions channel](https://18f.slack.com/messages/questions/).)_
...
* [Make a calendar reminder to badger for access to On-line University (OLU).]({{ site.baseurl }}/olu/), GSA's mandatory training courses.
    * You won't have access until you are set up in CHRIS, but once you have access, training is mandatory or you lose computer privileges.
...
* [Consulting]({{ site.baseurl }}/private/consulting/onboarding/)
...
* [Answer these five questions to get your bio on the 18F Team page.](https://docs.google.com/a/gsa.gov/forms/d/1XRCkQZw3-1JoZh6tm4k1qbunEnvJdOvDrTjRCqs-dp4/viewform?usp=send_form)
...
* Read some [Slack tips.](../private/slack-tips/)
